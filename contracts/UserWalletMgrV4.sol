...
/// @custom:oz-upgrades-from UserWalletMgrV3
contract UserWalletMgrV4 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Events
    ...
    mapping(address => string) private userIpfsCids;
    ...
    // retrieve user's current deposited balance
    ...
    // retrieve user's current deposited balance
    function getUserWallet() external view returns (address) {
        address wallet = userWallets[msg.sender];
        return wallet;
